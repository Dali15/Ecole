...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Liste Des Eleves</h3>
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table class="table table-bordered"> 
							...
							<thead> 
								<tr> 
									<th>#</th> 
	  								<c:forEach var="element2" items="${listData2}" >
            							<th>${element2}</th> 
            						</c:forEach>
						 		</tr> 
						 	</thead> 
							...
							<tbody> 
						 	 	<c:forEach var="element" items="${listData}" varStatus="theCount">
		 	     				      <tr>
	  									  <th scope="row">${theCount.count}</th>
            								<td>${element.nom}</td> 
            								<td>${element.prenom}</td> 
               								<td>${element.addresse}</td>
       								 </tr> 
   								 </c:forEach>
