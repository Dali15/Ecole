	...
	<div class="main-content">
				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							...
							<input type="hidden" name="testID" id="testID" value="dd"/>
							<a href="EleveSrv?testID=dash" class="active"><i class="fa fa-home nav_icon"></i>Dashboard</a>
						</li>
						<li>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="row-one">
					<div class="col-md-4 widget">
						...
						<div class="stats-right">
					 	<c:forEach var="element" items="${listData2}" >
            				<label> ${element}<label> 
            			</c:forEach>
						</div>
						<div class="clearfix"> </div>	
				...
				<form action="EleveSrv" method="get">
